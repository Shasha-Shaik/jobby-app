...
const apiStatusConstantsJobItemDetails = {
  initial: 'INITIAL',
...
class JobItemDetails extends Component {
  state = {
    jobItemList: {},
    similarJobItemList: [],
    apiStatus: apiStatusConstantsJobItemDetails.initial,
  }
  ...
  getJobItem = async () => {
    this.setState({
      apiStatus: apiStatusConstantsJobItemDetails.inprogress,
    })
    ...
    if (response.ok === true) {
      ...
      this.setState({
        ...
        apiStatus: apiStatusConstantsJobItemDetails.success,
      })
    } else {
      this.setState({
        apiStatus: apiStatusConstantsJobItemDetails.failure,
      })
    }
  }
        ...
        <div className="job-items-container">
          ...
          <ul className="skill-container">
            {skills.map(eachSkill => (
              <li className="skill-list-items" key={eachSkill.name}>
  ...
  renderFailureView = () => (
    <div className="render-loading-view">
      ...
      <button
        ...
        onClick={this.getJobItemDetailsApiCall}
      >
        Retry
      </button>
    </div>
  ...
  renderJobViews = () => {
    ...
    switch (apiStatus) {
      case apiStatusConstantsJobItemDetails.success:
        return this.renderJobItemDetails()
      case apiStatusConstantsJobItemDetails.inprogress:
        return this.renderLoadingView()
      case apiStatusConstantsJobItemDetails.failure:
